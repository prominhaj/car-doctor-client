...
const Product_Card = () => {
    return (
        <div className='p-[20px] group/item cursor-pointer bg-white rounded-[10px] border border-gray-200'>
            <div className='bg-[#F3F3F3] rounded-lg p-10 relative'>
                <button className='group/edit ease-in-out duration-100 invisible group-hover/item:visible w-[53px] absolute right-10 h-[53px] bg-white rounded-[10px]'>
