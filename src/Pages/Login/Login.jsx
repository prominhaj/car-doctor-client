            ...
            <div className="rounded-[10px] py-[50px] px-[30px] sm:px-[80px] border border-stone-300">
                <form onSubmit={handleSingIn}>
                    ...
                    <div className="flex flex-col gap-7 mt-6">
                        ...
                        <button type="submit" className="text-center py-3 mt-2 bg-[#FF3811] btn rounded-[10px] text-white text-xl font-medium font-['Inter'] leading-none border-none">Sign In</button>
                    </div>
